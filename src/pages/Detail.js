...
const Detail = () => {
  ...
  return (
    ...
    <div className="trip-info">
          <div className='trip_name state'>Issued</div>
          <div className='trip_name trip2'>Depature Trip : Sydney - ChaoShan</div>
          ...
          <div className="flight-segment">
            ...
            <span className="box-text">QR Code Ticket</span>
            <FontAwesomeIcon icon={faQrcode} className="box-icon" />
            </div>
          </div>
          </div>
